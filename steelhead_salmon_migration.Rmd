...
![_**Bonneville Dam in Oregon.** Created with [Google map](https://www.google.com/maps/place/Bonneville+Dam,+Cascade+Locks,+OR+97014/@46.1316382,-124.4946707,6.48z/data=!4m5!3m4!1s0x5495e7d00d2ce141:0xb922e9e1f966198c!8m2!3d45.6442837!4d-121.9406369) (Feb. 20th 2020)._](dam picture.png){width=70%}


![_**Steelhead Salmon (Oncorhynchus mykiss).** Image downloaded from [NSEA](https://www.n-sea.org/steelhead-trout)._](steelhead.jpeg)
...
cbr_fish <- read_csv("cbr_fish_passage_bonneville_allyrs_steelhead.csv") %>% 
  clean_names()
