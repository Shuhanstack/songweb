...
![_**Figure 1: Hawaii main islands.** Image download from [mother's niche](https://mothersniche.com/hawaiian-islands/)._](Hawaiian_Islands_Map.jpg){width=50%}
...
hw_land_use <- read_sf(dsn = here("land_use_land_cover_lulc"), layer = "Land_Use_Land_Cover_LULC") 

hw_water <- read_sf(dsn = here("watersheds_HW"), layer = "Watersheds")
```
