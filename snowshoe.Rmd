...
![Snowshoe hares in winter](white.jpg){width=700px} 



![Snowshoe hares in summer](black.jpg){width=700px}

*Picture in winter was downloaded from [Cottage Life](https://cottagelife.com/outdoors/wild-profile-meet-the-snowshoe-hare/) and the one in summer was from [Montana  Public Radio](https://www.mtpr.org/post/strange-practical-why-snowshoe-hares-eat-their-own-feces).*
...
snowshoe <- read_csv(here("project", "assignment1", "data", "showshoe_lter.csv"))
```
